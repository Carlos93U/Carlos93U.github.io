...
function renderCV() {
    ...
    const websiteUrl = cvData.personalInfo.website;
    document.getElementById('website').innerHTML = `<a href="${websiteUrl}" target="_blank" rel="noopener noreferrer">Website</a>`;
